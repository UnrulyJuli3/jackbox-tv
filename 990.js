/*! For license information please see 990.7e0e2830658a2a9178fb.js.LICENSE.txt */
(self.webpackChunkjackbox_tv = self.webpackChunkjackbox_tv || []).push([
    [990], {
        3682: (t, e, n) => {
            ...
            var o, i, r = "function" == typeof Map ? new Map : (o = [], i = [], {
                    has: function(t) {
                        return o.indexOf(t) > -1
                    },
                    get: function(t) {
                        return i[o.indexOf(t)]
                    },
                    set: function(t, e) {
                        -1 === o.indexOf(t) && (o.push(t), i.push(e))
                    },
                    delete: function(t) {
                        var e = o.indexOf(t);
                        e > -1 && (o.splice(e, 1), i.splice(e, 1))
                    }
                }),
                a = function(t) {
                    return new Event(t, {
                ...
                return t && Array.prototype.forEach.call(t.length ? t : [t], (function(t) {
                    return function(t) {
                        if (t && t.nodeName && "TEXTAREA" === t.nodeName && !r.has(t)) {
                            ...
                            t.addEventListener("autosize:destroy", s, !1), "onpropertychange" in t && "oninput" in t && t.addEventListener("keyup", d, !1), window.addEventListener("resize", l, !1), t.addEventListener("input", d, !1), t.addEventListener("autosize:update", d, !1), t.style.overflowX = "hidden", t.style.wordWrap = "break-word", r.set(t, {
                                destroy: s,
                                update: d
                        ...
                        function d() {
                            ...
                            if (o < e ? "hidden" === n.overflowY && (c("scroll"), u(), o = "content-box" === n.boxSizing ? Math.round(parseFloat(window.getComputedStyle(t, null).height)) : t.offsetHeight) : "hidden" !== n.overflowY && (c("hidden"), u(), o = "content-box" === n.boxSizing ? Math.round(parseFloat(window.getComputedStyle(t, null).height)) : t.offsetHeight), i !== o) {
                                i = o;
        ...
        51474: (t, e, n) => {
            ...
            var G, U, V, Z, q, Q, K, $, J, tt, et, nt, ot, it, rt, at, lt, st, ct, ut, dt, ht, ft, pt, gt, vt = !1,
                mt = !1,
                bt = [],
                yt = !1,
                wt = !1,
            ...
            Xt.prototype = {
                ...
                _prepareDragStart: function(t, e, n) {
                    ...
                    if (n && !G && n.parentNode === r) {
                        var s = N(n);
                        if (Z = r, U = (G = n).parentNode, q = G.nextSibling, Q = n, ot = a.group, Xt.dragged = G, rt = {
                                target: G,
                                clientX: (e || t).clientX,
                                clientY: (e || t).clientY
                ...
                _triggerDragStart: function(t, e) {
                    e = e || "touch" == t.pointerType && t, !this.nativeDraggable || e ? this.options.supportPointer ? v(document, "pointermove", this._onTouchMove) : v(document, e ? "touchmove" : "mousemove", this._onTouchMove) : (v(G, "dragend", this), v(Z, "dragstart", this._onDragStart));
                    try {
                ...
                _onDragStart: function(t, e) {
                    ...
                    W("dragStart", this, {
                        ...
                        W("clone", n), Xt.eventCanceled || (n.options.removeCloneOnHide || Z.insertBefore(K, G), n._hideClone(), j({
                            sortable: n,
                            name: "clone"
                        }))
                ...
                _onDragOver: function(t) {
                    ...
                    if (!St) {
                        ...
                        if (mt = !1, u && !s.disabled && (d ? h || (o = !Z.contains(G)) : it === this || (this.lastPutMode = ot.checkPull(this, u, G, t)) && c.checkPut(this, u, G, t))) {
                            if (i = "vertical" === this._getDirection(t, l), e = N(G), Y("dragOverValid"), Xt.eventCanceled) return g;
                            if (o) return U = Z, F(), this._hideClone(), Y("revert"), Xt.eventCanceled || (q ? Z.insertBefore(G, q) : Z.appendChild(G)), L(!0);
                            ...
                            if (!v || function(t, e, n) {
                                ...
                                if (v === G) return L(!1);
                                if (v && r === t.target && (l = v), l && (n = N(l)), !1 !== Yt(Z, r, G, e, l, n, t, !!l)) return F(), r.appendChild(G), U = r, B(), L(!0)
                                ...
                                if (ht !== l && (b = n[T], yt = !1, wt = !S && s.invertSwap || E), m = function(t, e, n, o, i, r, a, l) {
                                    ...
                                    }(t, l, n, i, S ? 1 : s.swapThreshold, null == s.invertedSwapThreshold ? s.swapThreshold : s.invertedSwapThreshold, wt, ht === l), 0 !== m) {
                                    var O = I(G);
                                    do {
                                        O -= m, y = U.children[O]
                ...
                _nulling: function() {
                    W("nulling", this), Z = G = U = V = q = K = Q = $ = rt = at = dt = tt = nt = J = et = ht = ft = it = ot = Xt.dragged = Xt.ghost = Xt.clone = Xt.active = null, _t.forEach((function(t) {
                        t.checked = !0
                    })), _t.length = lt = st = 0
                },
                ...
                _showClone: function(t) {
                    if ("clone" === t.lastPutMode) {
                        if ($) {
                            ...
                            G.parentNode != Z || this.options.group.revertClone ? q ? Z.insertBefore(K, q) : Z.appendChild(K) : Z.insertBefore(K, G), this.options.group.revertClone && this.animate(G, K), D(K, "display", ""), $ = !1
                        }
                    ...
                    if (e.scroll) {
                        ...
                        do {
                            ...
                            Zt[d].vx == A && Zt[d].vy == I && Zt[d].el === f || (Zt[d].el = f, Zt[d].vx = A, Zt[d].vy = I, clearInterval(Zt[d].pid), 0 == A && 0 == I || (u = !0, Zt[d].pid = setInterval(function() {
                                ...
                                "function" == typeof i && "continue" !== i.call(Xt.dragged.parentNode[z], n, e, t, Ut, Zt[this.layer].el) || R(Zt[this.layer].el, n, e)
                            }.bind({
                                layer: d
                            }), 24))), d++
            ...
            te.prototype = {
                ...
                return t.prototype = {
                    ...
                    nulling: function() {
                        Ut = Wt = Ht = qt = Vt = jt = Gt = null, Zt.length = 0
                    },
                    ...
                    _handleAutoScroll: function(t, e) {
                        ...
                        if (Ut = t, e || u || c || h) {
                            ...
                            var a = k(r, !0);
                            !qt || Vt && o === jt && i === Gt || (Vt && Kt(), Vt = setInterval((function() {
...
//# sourceMappingURL=sourcemaps/990.7e0e2830658a2a9178fb.js.map