(self.webpackChunkjackbox_tv = self.webpackChunkjackbox_tv || []).push([
    [7608], {
        ...
        97608: (e, t, s) => {
            ...
            class d {
                constructor(e) {
                    R.K.shared.isSupported ? "/access_token" === (null == e ? void 0 : e.substr(0, 13)) && this.processRedirect(e) : console.warn("Twitch Login requires local storage")
                }
                prepare() {
                    return R.K.shared.isSupported ? (S.v.debug && (0, u.c)("[Twitch] prepare"), R.K.shared.get("token") ? this.fetchUser() : null) : null
                }
                login() {
                    if (!R.K.shared.isSupported) return;
                    (0, u.c)("[Twitch] login");
                    const e = (0, o.Z)();
                    R.K.shared.set("twitchState", e);
                    const t = S.v.twitch.clientId;
                ...
                logout() {
                    R.K.shared.isSupported && ((0, u.c)("[Twitch] logout"), delete this.user, R.K.shared.remove("token"))
                }
                processRedirect(e) {
                    if (!R.K.shared.isSupported) return;
                    (0, u.c)("[Twitch] processRedirect", e);
                    const t = R.K.shared.get("twitchState");
                    ...
                    i.state !== t && console.error("[Twitch] State parameter doesn't match the expected state"), R.K.shared.set("token", i.access_token), R.K.shared.remove("twitchState"), window.history.replaceState({}, document.title, "/")
                }
                fetchUser() {
                    return e = this, t = void 0, i = function*() {
                        if (!R.K.shared.isSupported) return null;
                        const e = R.K.shared.get("token");
                        if (!e) throw new Error("[Twitch] Token not found in local storage");
                        try {
                            const t = yield fetch("https://api.twitch.tv/helix/users", {
                                headers: {
                                    Authorization: `Bearer ${e}`,
                                    "Client-ID": S.v.twitch.clientId
                                }
                            }), s = yield t.json();
            ...
            const G = {
                    ...
                    fr: {
                        ...
                        STRING_STYLE_WARNING: "[b]ATTENTION :[/b] votre navigateur semble être obsolète. Vous risquez de rencontrer des problèmes d'affichage avec ce jeu.",
                        STRING_NAME: "NOM",
                    ...
                    it: {
                        STATUS_GAME_FULL: "La stanza è piena",
                        SUBMIT_GAME_FULL: "LA STANZA È PIENA",
                    ...
                    de: {
                        STATUS_GAME_FULL: "Der Raum ist voll",
                        SUBMIT_GAME_FULL: "DER RAUM IST VOLL",
                    ...
                    es: {
                        STATUS_GAME_FULL: "La sala está llena",
                        SUBMIT_GAME_FULL: "LA SALA ESTÁ LLENA",
            ...
            var p = s(51900),
                v = (0, p.Z)(m, b, [], !1, null, "082a7a6a", null);
            v.options.__file = "src/apps/entry/views/signIn/Menu.vue";
            const C = v.exports;
            var g = function() {
                var e = this,
                    t = e.$createElement,
            ...
            const M = n().extend({
                ...
                computed: {
                    config() {
                        return (0, c.cF)(this.artifact.gameName)
                    },
                    name() {
                        var e, t;
                ...
                methods: {
                    ...
                    onClick(e) {
                        ...
                        E.Q.setAsViewed(this.index), this.viewed = !0, this.$analytics.trackEvent({
                            category: "SignIn",
            ...
            var D = (0, p.Z)(M, U, [], !1, null, "556a942f", null);
            D.options.__file = "src/apps/entry/views/signIn/PastGame.vue";
            const L = D.exports,
                f = n().extend({
                    components: {
                        PastGame: L
            ...
            var w = (0, p.Z)(f, g, [], !1, null, "5b9392d4", null);
            w.options.__file = "src/apps/entry/views/signIn/PastGames.vue";
            const H = w.exports,
                k = n().extend({
                    components: {
                        Menu: C,
            ...
            var P = (0, p.Z)(k, O, [], !1, null, "8691596e", null);
            P.options.__file = "src/apps/entry/views/signIn/TopBar.vue";
            const W = P.exports;
            var y = function() {
                var e = this,
                    t = e.$createElement,
            ...
            var x = (0, p.Z)(z, y, [], !1, null, "29eab9d7", null);
            x.options.__file = "src/apps/entry/views/signIn/PasswordModal.vue";
            const B = x.exports;
            var j = function() {
                var e = this,
                    t = e.$createElement,
            ...
            j._withStripped = !0;
            const F = n().extend({});
            var V = (0, p.Z)(F, j, [], !1, null, "e6c8e964", null);
            V.options.__file = "src/apps/entry/views/signIn/PrereleaseModal.vue";
            const Y = V.exports;
            var q = function() {
                var e = this,
                    t = e.$createElement,
                ...
                methods: {
                    load() {
                        ...
                        return t = this, s = void 0, a = function*() {
                            try {
                                const t = yield fetch(S.v.banners.url), s = yield t.json(), i = null !== (e = null == s ? void 0 : s.bannerAds) && void 0 !== e ? e : [];
                    ...
                    isValidBanner(e) {
                        var t, s;
                        const i = new Date;
                        if (R.K.shared.isSupported && e.tags) {
                            const i = null !== (t = e.tags) && void 0 !== t ? t : [],
                                a = JSON.parse(null !== (s = R.K.shared.get("tags")) && void 0 !== s ? s : "[]");
            ...
            var Q = (0, p.Z)(J, q, [], !1, null, "bd07a9fc", null);
            Q.options.__file = "src/apps/entry/views/signIn/SlideBanner.vue";
            const Z = Q.exports;
            ...
            const ee = n().extend({
                ...
                data() {
                    return {
                        ...
                        notFound: !1,
                        artifacts: new E.Q,
                        twitch: new d(this.$route.redirectedFrom),
                        warnings: []
                    }
                },
                computed: {
                    ...
                    formState() {
                        ...
                        if (!this.room) return {
                            ...
                            submitText: "SUBMIT_PLAY"
                        };
                        const s = null !== (t = null === (e = (0, c.cF)(this.room.appTag)) || void 0 === e ? void 0 : e.name) && void 0 !== t ? t : "???";
                ...
                methods: {
                        ...
                        return X(this, void 0, void 0, (function*() {
                            this.room && (this.warnings = yield class {
                                static warningsForAppTag(e) {
                                    var t, s, i, a, n;
                                    return s = this, i = void 0, n = function*() {
                                        const s = [],
                                            i = (0, c.cF)(e);
                    ...
                    onNameInput() {
                        ...
                        const e = T.c.sanitizeName(this.name);
                    ...
                    getConnectOptions(e) {
                        ...
                        let i = T.c.sanitizeName(this.name).trim();
                        ...
                        return this.twitch.user && (n.twitchToken = this.twitch.user.token), this.isReconnectable && (n.id = this.reconnectData.id, n.secret = this.reconnectData.secret), n
                    },
                    connect(e) {
                        return X(this, void 0, void 0, (function*() {
                            if (!e) return;
                            ...
                            if ((0, c.iU)(this.room.appId)) return this.showPreReleaseModal();
                                ...
                                this.$ecast = i, this.$syncEcast(), this.$setSentryTag("role", this.$ecast.role), this.$debug.setup(this.$ecast, this.room), this.trackConnectEvent(), this.$storage.isSupported && (this.$storage.set("name", t.name), this.$storage.set("roomCode", this.code), this.$storage.set("reconnect", `${a.id}:${e}:${a.secret}`)), yield class {
                                    static load(e) {
                                        return l(this, void 0, void 0, (function*() {
                                            (0, u.c)("[GameLoader] load", e);
                                            const t = (0, c.cF)(e.room.appTag);
                                            if (!t) throw Error(`[GameLoader] no games exist with tag (${e.room.appTag})`);
                                            const i = "vue" === t.app ? () => l(this, void 0, void 0, (function*() {
                                                return s.e(9139).then(s.bind(s, 59139))
                    ...
                    onConnectionError(e, t) {
                        var s;
                        return X(this, void 0, void 0, (function*() {
                            return e instanceof _.EcastRoomIsFull ? "audience" === t ? this.promptForRetry("ERROR_AUDIENCE_FULL") : this.promptForRetry("ERROR_ROOM_FULL") : e instanceof _.EcastRoomIsLocked ? this.promptForRetry("STRING_ERROR_ROOM_IS_LOCKED") : e instanceof _.EcastInvalidPassword ? (yield this.$showModal("Error", {
                                text: this.$t("ERROR.TITLE"),
                                subtext: this.$t("STRING_ERROR_INCORRECT_PASSWORD"),
                                dismissText: this.$t("ACTION.TRY_AGAIN")
                            }), this.password = "", this.connect("player")) : e instanceof _.EcastRoomNotFound ? this.showError("ERROR.ROOM_NOT_FOUND") : e instanceof _.EcastTwitchLoginRequired ? this.showError("STRING_ERROR_REQUIRES_TWITCH_LOGIN") : e instanceof _.EcastPasswordRequired ? this.showError("STRING_PASSWORD_REQUIRED_TITLE") : e instanceof _.EcastFilterError ? this.showError("STRING_ERROR_FILTER_NAME") : (null === (s = e.message) || void 0 === s ? void 0 : s.includes("Network request failed")) ? this.showError("ERROR_UNABLE_TO_CONNECT") : void this.showError("STRING_ERROR_GENERIC")
                        }))
                    },
                    promptForRetry(e) {
                        var t;
            ...
            var te = (0, p.Z)(ee, i, [], !1, null, "2ba6adc4", null);
            te.options.__file = "src/apps/entry/views/signIn/Main.vue";
            const se = te.exports
        },
        6305: (e, t, s) => {
            "use strict";
                ...
                methods: {
                    onInput(e) {
                        return t = this, s = void 0, a = function*() {
                            ...
                            t.value.length > s ? t.value = t.value.substring(0, s) : (this.$emit("input", t.value), yield n().nextTick(), t.value !== this.value && (t.value = this.value))
                        }, new((i = void 0) || (i = Promise))((function(e, n) {
                            function o(e) {
                                try {
                                    _(a.next(e))
            ...
            var r = (0, s(51900).Z)(o, i, [], !1, null, null, null);
...
//# sourceMappingURL=7608.e1dfa03baa380694bad0.js.map