    ...
    ["games/bracketeering"], {
        10335: (e, t, o) => {
            ...
            const m = d.E.extend({
                    ...
                    bindings: c().extend({}, d.E.prototype.bindings, {
                        ".chosen": {},
                        "#instructions": {
                            observe: "text",
                            updateMethod: "html",
                    ...
                    update() {
                        ...
                        t || c().each(this.choicesList.collection.models, ((e, o) => {
                ...
                p = n.v.extend({
                    ...
                    getGameLayout(e) {
                        return "MakeSingleChoice" === e ? this.setLayout(m) : -1
                    },
...
//# sourceMappingURL=sourcemaps/2639.b104a93d333424955951.js.map