    ...
    ["games/quiplash3"], {
        19187: (t, e, i) => {
            ...
            const p = [169, 174, 8252, 8265, 8482, 8505, 8596, 8597, 8598, 8599, 8600, 8601, 8617, 8618, 9e3, 8986, 8987, 9167, 9193, 9194, 9195, 9196, 9197, 9198, 9199, 9200, 9201, 9202, 9203, 9209, 9210, 9410, 9642, 9643, 9654, 9664, 9723, 9724, 9725, 9726, 9728, 9729, 9730, 9731, 9732, 9742, 9745, 9748, 9749, 9752, 9757, 9760, 9762, 9763, 9766, 9770, 9774, 9775, 9784, 9785, 9786, 9792, 9794, 9800, 9801, 9802, 9803, 9804, 9805, 9806, 9807, 9808, 9809, 9810, 9811, 9824, 9827, 9829, 9830, 9832, 9851, 9854, 9855, 9874, 9875, 9876, 9877, 9878, 9879, 9881, 9883, 9884, 9888, 9823, 9889, 9895, 9898, 9899, 9904, 9905, 9917, 9918, 9924, 9925, 9928, 9934, 9935, 9937, 9939, 9940, 9961, 9962, 9968, 9969, 9970, 9971, 9972, 9973, 9974, 9975, 9976, 9977, 9978, 9981, 9986, 9989, 9992, 9993, 9994, 9995, 9996, 9997, 9999, 10002, 10004, 10006, 10013, 10017, 10024, 10035, 10036, 10052, 10055, 10060, 10062, 10067, 10068, 10069, 10071, 10083, 10084, 10085, 10133, 10134, 10135, 10145, 10160, 10175, 10548, 10549, 11013, 11014, 11015, 11035, 11036, 11088, 11093, 12336, 12349, 12951, 12953, 58634],
                ...
                y = (t, e) => !!t && parseInt(t.charCodeAt(0).toString(16), 16) === e,
                x = t => /[\uD800-\uDB7F]/.test(t),
                C = t => /[\u0023\u002A\u0030-\u0039]/.test(t),
                w = t => {
                ...
                I = (t, e) => {
                    ...
                    for (; n && e < t.length;) {
                        ...
                        if (x(o)) {
                            const s = v(o, t[e + 1]);
                            g.includes(s) ? (i = i + o + t[e + 1], e += 2) : n = !1
                        } else y(o, m) ? (i = i + o + t[e + 1] + t[e + 2], e += 3) : n = !1
                    }
                    return {
                        modifyingChars: i,
                        newPosition: e
                    ...
                    for (let t = 0; t < i.length && (!e || n < e); t += 1) {
                        ...
                        if (/[\u00A1\u0020-\u0022\u0024-\u0029\u002B-\u002F\u003A-\u007E\u00BF-\u00FF’]/gi.test(e)) o += e, n += 1;
                            ...
                            if (x(e)) {
                                ...
                                if (w(a)) {
                                    const e = v(i[t + 1], i[t + 2]);
                                    w(e) && (o = o + i[t + 1] + i[t + 2], t += 1), n += 1;
                                    continue
                                }
                                if (127988 === a) {
                                    const e = i[t + 1];
                                    y(e, m) && (o = o + e + i[t + 2] + i[t + 3], t += 3), n += 1;
                                    continue
                                }
                                if (127987 === a) {
                                    const e = i[t + 1];
                                    y(e, b) && (t += 1, y(i[t + 1], m) && (o = o + e + i[t + 1] + i[t + 2] + i[t + 3], t += 3)), n += 1;
                                    continue
                                }
                                g.includes(a) || (n += 1);
                                continue
                            ...
                            if (C(e)) {
                                const s = i[t + 1];
                                s && y(s, b) ? (o = o + e + i[t + 1] + i[t + 2], t += 2) : o += e, n += 1;
                                continue
                            }(y(e, b) || y(e, m) || y(e, 8419)) && (o += e)
                        }
                    }
                    return {
                        result: o,
                ...
                O = d.E.extend({
                    ...
                    onInputChange() {
                        ...
                        if (!t.length) return;
                        const e = S(t.val(), this.model.get("maxLength"));
                    ...
                    sanitizeInput(t) {
                        return S(t, this.model.get("maxLength")).result
                    }
                }),
                E = u.S.extend({
                    defaults: {
                ...
                L = c.G.extend({
                    model: new E,
                    initialize(t) {
                        this.inputComponent = this.inputComponent || new O({
                            model: new(r().Model)({})
            ...
            const N = O.extend({
                ...
                M = r().Collection.extend({
                    model: D,
                    childViewOptions: (t, e) => ({
                        childIndex: e
                    })
                }),
                A = R().CollectionView.extend({
                    className: "fields",
                    childView: N,
                    collection: new M,
                ...
                K = R().View.extend({
                    ...
                    bindings: {
                        ...
                        ".doneText": {
                            observe: "doneText",
                            updateMethod: "html",
                            onGet: t => t ? t.html ? t.html : k()("<div />").text(t.text).html() : ""
                        },
                        ".parentErrorText": {
                            observe: "error",
                            updateMethod: "html",
                            onGet: t => t ? "object" == typeof t ? t.html ? t.html : k()("<div />").text(t.text).html() : t : null
                        }
                    },
                    initialize() {
                        this.shouldSubmit = !1, this.promptComponent = new G.y({
                            model: new(r().Model)({
                                text: "",
                                className: ""
                            })
                        }), this.inputsComponent = new A, this.buttonsCollection = new(r().Collection)([{
                            text: "submit"
                        }]), this.buttonsComponent = new z.C({
                            childView: j.r,
                            block: !0,
                    ...
                    update() {
                        ...
                        if (this.model.get("actions").forEach((e => {
                            ...
                            const t = [];
                            for (let e = this.model.get("fieldCount"); e > 0; e--) t.push(F(F({}, this.model.attributes), {}, {
                                counter: !0,
                                hideError: !0,
                                isLastChild: 1 === e
                            }));
            ...
            const Q = d.E.extend({
                ...
                X = q.a.extend({
                    ...
                    regions: s().extend({}, q.a.prototype.regions, {
                        toggle: "#toggleRegion"
                    }),
                    initialize() {
                        this.inputComponent = this.inputComponent || new Q({
                            model: new(r().Model)({
                                inlineSubmit: !0,
                                inlineSubmitText: "",
                                className: "addPrompt",
                        ...
                        }), this.titleInputComponent = this.titleInputComponent || new Q({
                            model: new(r().Model)({
                                inlineSubmit: !0,
                                counter: !0
                            })
                        }), this.toggleComponent = this.toggleComponent || new J, q.a.prototype.initialize.apply(this)
                    },
                    onRender() {
                        q.a.prototype.onRender.apply(this), this.showChildView("toggle", this.toggleComponent)
                    },
                    update() {
                        q.a.prototype.update.apply(this), this.toggleComponent.model.setUpdate(this.model.get("toggle"))
                    },
                    onChildviewInputSubmit() {
                        let t, e;
            ...
            const it = n.v.extend({
                ...
                bindings: tt(tt({}, n.v.prototype.bindings), {}, {
                ...
                parseBlob(t) {
                    ...
                    return "MakeSingleChoice" === t.state && t.choices.forEach((t => {
                        ...
                        username: "AUDIENCE",
                        classes: ["Audience"]
                    }), "UGC" === t.state && (t.playerInfo.classes = s().union(t.playerInfo.classes, ["UGCView"])), t.textDescriptions && t.textDescriptions.length && (t.textDescriptions = t.textDescriptions.map((t => tt(tt({}, t), {}, {
