(self.webpackChunkjackbox_tv = self.webpackChunkjackbox_tv || []).push([
    ["games/the-wheel"], {
        ...
        75815: (t, s, e) => {
            ...
            class c {
                constructor(t, s) {
                    this.isCanceled = !1, this.distanceAccumulator = 0, this.velocityValues = [0], this.boundOnClick = this.onClick.bind(this), this.boundOnStart = this.onStart.bind(this), this.boundOnMove = this.onMove.bind(this), this.boundOnEnd = this.onEnd.bind(this), this.applyPolyfill(), this.element = t, this.usePointerEvents = void 0 !== window.PointerEvent, this.isRestrictedToBox = s.restrictToBox, this.bindStaticEvents()
                }
                destroy() {
                ...
                bindStartedEvents() {
                    if (this.usePointerEvents) return this.element.addEventListener("pointermove", this.boundOnMove), this.element.addEventListener("pointerup", this.boundOnEnd), this.isRestrictedToBox && this.element.addEventListener("pointerleave", this.boundOnEnd), void this.disableChildPointerEvents();
                ...
                unbindStartedEvents() {
                    if (this.usePointerEvents) return this.element.removeEventListener("pointermove", this.boundOnMove), this.element.removeEventListener("pointerup", this.boundOnEnd), this.isRestrictedToBox && this.element.removeEventListener("pointerleave", this.boundOnEnd), void this.enableChildPointerEvents();
                ...
                onClick(t) {
                    const s = this.getStartDetail(t),
                        e = new CustomEvent("pointerboxclick", {
                            detail: s
                        });
                    this.element.dispatchEvent(e)
                }
                onStart(t) {
                    if (t.preventDefault(), this.isCanceled = !1, this.usePointerEvents && !this.isRestrictedToBox) {
                        const s = t;
                        this.element.setPointerCapture(s.pointerId)
                    }
                    this.distanceAccumulator = 0, this.velocityValues = [0];
                    const s = this.getStartDetail(t);
                    this.initial = s, this.previous = s;
                    const e = new CustomEvent("pointerboxstart", {
                        detail: s
                    });
                    this.element.dispatchEvent(e);
                    ...
                    return this.StaticEventChildren = document.elementsFromPoint(s.clientX, s.clientY), this.StaticEventChildren.forEach((t => t.dispatchEvent(n))), this.bindStartedEvents(), !1
                }
                onMove(t) {
                    if (t.preventDefault(), this.isCanceled) return;
                    const s = this.getMoveDetail(t);
                    this.previous = s;
                    const e = new CustomEvent("pointerboxmove", {
                        detail: s
                    });
                    return this.element.dispatchEvent(e), this.previousEventTimestamp = Date.now(), !1
                }
                onEnd(t) {
                    if (t.preventDefault(), this.isCanceled) return;
                    const s = this.getMoveDetail(t),
                        e = new CustomEvent("pointerboxend", {
                            detail: s
                        });
                    this.element.dispatchEvent(e), delete this.initial, delete this.previous, delete this.cachedElementRect, delete this.previousEventTimestamp, this.unbindStartedEvents();
                    const n = new CustomEvent("pointerboxchildup", {
                        detail: s
                    });
                    return document.elementsFromPoint(s.clientX, s.clientY).forEach((t => {
                        var e;
                        if (t.dispatchEvent(n), !(null === (e = this.StaticEventChildren) || void 0 === e ? void 0 : e.includes(t))) return;
                ...
                disableChildPointerEvents() {
                    ...
                    for (let t = 0; t < this.element.children.length; t++) {
                        const s = this.element.children[t];
                        s.style.pointerEvents = "none", s.style.touchAction = "none"
                    }
                }
                enableChildPointerEvents() {
                    ...
                    for (let t = 0; t < this.element.children.length; t++) {
                        const s = this.element.children[t];
                        s.style.pointerEvents = "", s.style.touchAction = ""
                    }
                }
                getStartDetail(t) {
                    let s, e, n, i;
                    if (this.cachedElementRect || (this.cachedElementRect = this.element.getBoundingClientRect()), window.TouchEvent && t instanceof window.TouchEvent) {
                        if (!t.touches.length) return this.previous;
                        s = t.touches[0].pageX, e = t.touches[0].pageY, n = t.touches[0].clientX, i = t.touches[0].clientY
                    } else {
                        const l = t;
                        s = l.pageX, e = l.pageY, n = l.clientX, i = l.clientY
                    }
                    const l = s - this.cachedElementRect.left,
                        a = e - this.cachedElementRect.top,
                        c = l / this.cachedElementRect.width,
                        o = a / this.cachedElementRect.height;
                    return {
                        boxX: l,
                        boxY: a,
                        pageX: s,
                ...
                getMoveDetail(t) {
                    ...
                    const s = this.getStartDetail(t),
                        ...
                        n = a.c.getDistanceBetweenPoints({
                            x: this.initial.boxX,
                            y: this.initial.boxY
                        }, {
                            x: s.boxX,
                        ...
                        l = a.c.getDistanceBetweenPoints({
                            x: this.previous.boxX,
                            y: this.previous.boxY
                        }, {
                            x: s.boxX,
                    ...
                    this.distanceAccumulator += l;
                    let c = 0;
                    return this.previousEventTimestamp && (c = a.c.getVelocity({
                        x: this.previous.boxX,
                        y: this.previous.boxY
                        ...
                        degreesFromInitial: e,
                        distanceFromInitial: n,
                        changeXFromInitial: s.boxX - this.initial.boxX,
                        changeYFromInitial: s.boxY - this.initial.boxY,
                        degreesFromPrevious: i,
                        distancefromPrevious: l,
                        changeXFromPrevious: s.boxX - this.previous.boxX,
                        changeYFromPrevious: s.boxY - this.previous.boxY,
                        totalDistance: this.distanceAccumulator,
                        velocity: c,
                        normalizedVelocity: this.velocityValues.reduce(((t, s) => t + s)) / this.velocityValues.length,
                ...
                applyPolyfill() {
                    c.isPolyfilled || (c.isPolyfilled = !0, window && window.document && (window.document.elementsFromPoint || (window.document.elementsFromPoint = c.elementsFromPoint)))
                }
                static elementsFromPoint(t, s) {
                    const e = [],
                        n = [];
                    let i = null;
                    do {
                        const l = window.document.elementFromPoint(t, s);
                        i !== l ? (i = l, e.push(i), n.push(i.style.pointerEvents), i.style.pointerEvents = "none") : i = null
                    } while (i);
                    return e.forEach(((t, s) => {
                        t.style.pointerEvents = n[s]
                    })), e
                }
            }
            c.isPolyfilled = !1;
                ...
                r = {
                    ...
                    install(t) {
                        t.directive("pointerBox", {
                            inserted(t, s) {
                                const e = new c(t, {
                                    restrictToBox: s.modifiers.restrict
                                });
                                o.set(t, e)
                            },
                            unbind(t) {
                                var s;
                                null === (s = o.get(t)) || void 0 === s || s.destroy(), o.delete(t)
                            }
                        })
                    }
                };
            ...
            var v = e(51900),
                u = (0, v.Z)(d, h, [], !1, null, "ea891ba4", null);
            u.options.__file = "src/games/pp8/the-wheel/views/playfield/CornerBox.vue";
            const C = u.exports;
            var g = function() {
                var t = this,
                    s = t.$createElement,
            ...
            y.p8.registerPlugin(f.W), y.p8.registerPlugin(m.t);
            const M = l().extend({
                props: {
                    sliceCount: Number
                },
                ...
                mounted() {
                    this.generateTimeline(), m.t.create("custom", "M0,0 C0.42,0.05 0.65,0.82 0.72,0.99 0.78,0.91 0.84,0.93 0.85,0.95 0.87,0.96 0.89,0.98 0.91,0.99 0.92,0.99 0.93,0.98 0.95,0.98 0.96,0.98 1,1 1,1")
                },
                methods: {
                    generateTimeline() {
                        ...
                        this.timeline = y.p8.timeline().to(t, {
                            translateY: "-25%",
                            duration: .3
                        }).to(s, {
                            duration: .15,
            ...
            var b = (0, v.Z)(M, g, [], !1, null, "0885f1e2", null);
            b.options.__file = "src/games/pp8/the-wheel/views/playfield/SlicesBox.vue";
            const w = b.exports;
            const z = l().extend({
                components: {
                    CornerBox: C,
                ...
                watch: {
                    ...
                    status: function(t) {
                        return s = this, e = void 0, i = function*() {
                            ...
                            o((i = i.apply(s, e || [])).next())
                        }));
                        var s, e, n, i
                    }
                }
            });
            var L = (0, v.Z)(z, p, [], !1, null, "4ee1693e", null);
            L.options.__file = "src/games/pp8/the-wheel/views/playfield/Playfield.vue";
            const S = L.exports;
            var E = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var B = (0, v.Z)(A, E, [], !1, null, "5bd3a8f0", null);
            B.options.__file = "src/games/pp8/the-wheel/views/shared/FrozenBox.vue";
            const k = B.exports;
            var N = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var O = (0, v.Z)(P, Z, [], !1, null, "546fca46", null);
            O.options.__file = "src/games/pp8/the-wheel/views/shared/GemButton.vue";
            const T = O.exports;
            var I = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var $ = (0, v.Z)(R, I, [], !1, null, "136efdac", null);
            $.options.__file = "src/games/pp8/the-wheel/views/shared/PromptBox.vue";
            const D = $.exports;
            var G = function(t, s, e, n) {
                return new(e || (e = Promise))((function(i, l) {
                    function a(t) {
                        try {
                            o(n.next(t))
                        } catch (t) {
                    ...
                    function o(t) {
                        var s;
                        t.done ? i(t.value) : (s = t.value, s instanceof e ? s : new e((function(t) {
                            t(s)
                        }))).then(a, c)
                    }
            ...
            var Y = (0, v.Z)(U, N, [], !1, null, "48b5c973", null);
            Y.options.__file = "src/games/pp8/the-wheel/views/Choices.vue";
            const W = Y.exports;
            var K = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var H = (0, v.Z)(V, j, [], !1, null, "3ad8c1d9", null);
            H.options.__file = "src/games/pp8/the-wheel/views/slices/SubmitButton.vue";
            const F = H.exports;
            var q = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var J = (0, v.Z)(Q, X, [], !1, null, "33715074", null);
            J.options.__file = "src/games/pp8/the-wheel/views/wheel/backgrounds/Main.vue";
            const tt = J.exports;
            var st = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var nt = (0, v.Z)(et, st, [], !1, null, "5f0d0aca", null);
            nt.options.__file = "src/games/pp8/the-wheel/views/wheel/backgrounds/Place.vue";
            const it = nt.exports;
            var lt = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var ct = (0, v.Z)(at, lt, [], !1, null, "638ddd39", null);
            ct.options.__file = "src/games/pp8/the-wheel/views/wheel/backgrounds/Rainbow.vue";
            const ot = ct.exports;
            var rt = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var ht = (0, v.Z)(pt, rt, [], !1, null, "2e7f39df", null);
            ht.options.__file = "src/games/pp8/the-wheel/views/wheel/backgrounds/Win.vue";
            const dt = ht.exports;
            var vt = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var gt = (0, v.Z)(Ct, ut, [], !1, null, "0ddf39d8", null);
            gt.options.__file = "src/games/pp8/the-wheel/views/wheel/slices/Avatar.vue";
            const yt = gt.exports,
                mt = l().extend({
                    components: {
                        Avatar: yt
            ...
            var ft = (0, v.Z)(mt, vt, [], !1, null, "c9303b86", null);
            ft.options.__file = "src/games/pp8/the-wheel/views/wheel/slices/Graphic.vue";
            const xt = ft.exports;
            var _t = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var bt = (0, v.Z)(Mt, _t, [], !1, null, "e3f78ec8", null);
            bt.options.__file = "src/games/pp8/the-wheel/views/wheel/slices/Player.vue";
            const wt = bt.exports;
            var zt = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var St = (0, v.Z)(Lt, zt, [], !1, null, "7fc3befa", null);
            St.options.__file = "src/games/pp8/the-wheel/views/wheel/slices/Winner.vue";
            const Et = St.exports,
                At = l().extend({
                    components: {
                        BackgroundMain: tt,
                        BackgroundPlace: it,
                        BackgroundRainbow: ot,
                        BackgroundWin: dt,
                        SliceGraphic: xt,
                        SlicePlayer: wt,
                        SliceWinner: Et
            ...
            var Bt = (0, v.Z)(At, q, [], !1, null, "34dca79a", null);
            Bt.options.__file = "src/games/pp8/the-wheel/views/wheel/WheelBox.vue";
            const kt = Bt.exports;
            class Nt {
                constructor(t, s, e, n) {
                ...
                sync(t) {
                    ...
                    l().set(this.observable, "definitions", s)
                }
                parse(t) {
                    return t.map(((t, s) => {
                        switch (t.type) {
                    ...
                    if (this.isPlayerDefinition(s)) {
                        if (1 === s.playerStake) {
                            ...
                            return s.multiplier && (e.multiplier = s.multiplier, e.labelData = {
                                multiplier: s.multiplier
                            }), void l().set(this.observable.definitions, t, e)
                        }
            ...
            const Pt = l().extend({
                ...
                data() {
                    return {
                        isSending: !1,
                        manager: new Nt(this.player.slices, "choose", this.info, this.players)
                    }
                },
                computed: {
                    canSubmit() {
            ...
            var Ot = (0, v.Z)(Pt, K, [], !1, null, "72218387", null);
            Ot.options.__file = "src/games/pp8/the-wheel/views/slices/ChooseSlices.vue";
            const Tt = Ot.exports;
            var It = function() {
                var t = this,
                    s = t.$createElement,
                ...
                methods: {
                    onInput(t) {
                        return s = this, e = void 0, i = function*() {
                            ...
                            s.value.length > e ? s.value = s.value.substring(0, e) : (this.$emit("input", s.value), yield l().nextTick(), s.value !== this.value && (s.value = this.value))
                        }, new((n = void 0) || (n = Promise))((function(t, l) {
                            function a(t) {
                                try {
                                    o(i.next(t))
            ...
            var Dt = (0, v.Z)($t, Rt, [], !1, null, "0b0388af", null);
            Dt.options.__file = "src/games/pp8/the-wheel/views/shared/Input.vue";
            const Gt = Dt.exports;
            const Ut = l().extend({
                components: {
                    GemButton: T,
                ...
                methods: {
                    onSubmit() {
                        ...
                        }, new((e = void 0) || (e = Promise))((function(i, l) {
                            function a(t) {
                                try {
                                    o(n.next(t))
                                } catch (t) {
            ...
            var Yt = (0, v.Z)(Ut, It, [], !1, null, "451b4290", null);
            Yt.options.__file = "src/games/pp8/the-wheel/views/guessing/Guessing.vue";
            const Wt = Yt.exports;
            var Kt = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var Ht = (0, v.Z)(Vt, Kt, [], !1, null, "0ea76297", null);
            Ht.options.__file = "src/games/pp8/the-wheel/views/Lobby.vue";
            const Ft = Ht.exports;
            var qt = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var Jt = (0, v.Z)(Qt, Xt, [], !1, null, "6508ff64", null);
            Jt.options.__file = "src/games/pp8/the-wheel/views/matching/ArchesBox.vue";
            const ts = Jt.exports;
            const ss = l().extend({
                components: {
                    ArchesBox: ts,
                ...
                computed: {
                    ...
                    selectedItems() {
                        var t, s, e, n;
                        const i = ["", ""];
                        return this.selected[0] >= 0 && (i[0] = null !== (s = null === (t = this.items[0][this.selected[0]]) || void 0 === t ? void 0 : t.text) && void 0 !== s ? s : ""), this.selected[1] >= 0 && (i[1] = null !== (n = null === (e = this.items[1][this.selected[1]]) || void 0 === e ? void 0 : e.text) && void 0 !== n ? n : ""), i
                    },
                    items() {
                ...
                methods: {
                    ...
                    submit() {
                        var t, s, e, n, i, l;
                        return e = this, n = void 0, l = function*() {
                            ...
                            function o(s) {
                                var e;
                                s.done ? t(s.value) : (e = s.value, e instanceof i ? e : new i((function(t) {
                                    t(e)
                                }))).then(a, c)
                            }
            ...
            var es = (0, v.Z)(ss, qt, [], !1, null, "337a0260", null);
            es.options.__file = "src/games/pp8/the-wheel/views/matching/Matching.vue";
            const ns = es.exports;
            var is = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var cs = (0, v.Z)(as, ls, [], !1, null, "7fd86d44", null);
            cs.options.__file = "src/games/pp8/the-wheel/views/numeric/DigitsBox.vue";
            const os = cs.exports;
            var rs = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var hs = (0, v.Z)(ps, rs, [], !1, null, "83ecf6ee", null);
            hs.options.__file = "src/games/pp8/the-wheel/views/numeric/HandsetBox.vue";
            const ds = hs.exports;
            var vs = function(t, s, e, n) {
                return new(e || (e = Promise))((function(i, l) {
                    function a(t) {
                        try {
                            o(n.next(t))
            ...
            var Cs = (0, v.Z)(us, is, [], !1, null, "05553b0c", null);
            Cs.options.__file = "src/games/pp8/the-wheel/views/numeric/Numeric.vue";
            const gs = Cs.exports;
            var ys = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var xs = (0, v.Z)(fs, ms, [], !1, null, "d95ed536", null);
            xs.options.__file = "src/games/pp8/the-wheel/views/slices/UndoButton.vue";
            const _s = xs.exports;
            ...
            const bs = l().extend({
                ...
                data() {
                    return {
                        ...
                        history: [],
                        manager: new Nt(this.player.slices, "place", this.info, this.players)
                    }
                },
                computed: {
                    isPatched() {
            ...
            var ws = (0, v.Z)(bs, ys, [], !1, null, "7418dde9", null);
            ws.options.__file = "src/games/pp8/the-wheel/views/slices/PlaceSlices.vue";
            const zs = ws.exports;
            var Ls = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var Bs = (0, v.Z)(As, Ls, [], !1, null, "3ccfa681", null);
            Bs.options.__file = "src/games/pp8/the-wheel/views/PostGame.vue";
            const ks = Bs.exports;
            var Ns = function() {
                var t = this,
                    s = t.$createElement,
                    ...
                    onSubmit() {
                        return t = this, s = void 0, n = function*() {
                            try {
                                ...
                                if (t instanceof Zs.EcastFilterError) return void(this.filterError = !0);
                                this.$handleEcastError(t)
                            }
                        }, new((e = void 0) || (e = Promise))((function(i, l) {
                            function a(t) {
            ...
            var Os = (0, v.Z)(Ps, Ns, [], !1, null, "b7520044", null);
            Os.options.__file = "src/games/pp8/the-wheel/views/SingleTextEntry.vue";
            const Ts = Os.exports;
            var Is = function() {
                var t = this,
                    s = t.$createElement,
            ...
            Us._withStripped = !0;
            const Ys = l().extend({});
            var Ws = (0, v.Z)(Ys, Us, [], !1, null, "106f6fec", null);
            Ws.options.__file = "src/games/pp8/the-wheel/views/spin/Answer.vue";
            const Ks = Ws.exports;
            var js = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var Fs = (0, v.Z)(Hs, Vs, [], !1, null, "410a49b0", null);
            Fs.options.__file = "src/games/pp8/the-wheel/views/spin/ArrowBox.vue";
            const qs = Fs.exports,
                Xs = l().extend({
                    components: {
                        ArrowBox: qs
            ...
            var Qs = (0, v.Z)(Xs, js, [], !1, null, "0184ede7", null);
            Qs.options.__file = "src/games/pp8/the-wheel/views/spin/Main.vue";
            const Js = Qs.exports;
            var te = function() {
                var t = this,
                    s = t.$createElement,
            ...
            const se = l().extend({
                ...
                data: () => ({
                    offTimeline: y.ZP.timeline(),
                    onTimeline: y.ZP.timeline({
                        repeat: -1
                    }),
                    colors: [
                        ...
                        s.forEach((s => {
                            ...
                            for (let i = 0; i < n; i++)
                                for (let n = 0; n < s.pattern.length; n++) {
                                    ...
                                    s.wait && 0 === i && (e[n][1] += s.wait);
                                    for (let i = 0; i < s.pattern[n].length; i++) {
                                        if (s.pattern[n][i] !== e[n][0]) {
                                            e[n][0] = s.pattern[n][i];
                                            const a = {
                                                flood: 3,
                                                arm: 2
                                            };
                                            "i" === s.pattern[n][i] && (a.flood = 2, a.arm = 1), "x" === s.pattern[n][i] && (a.flood = 1, a.arm = 0), t.set(l, {
            ...
            var ee = (0, v.Z)(se, te, [], !1, null, "676f8778", null);
            ee.options.__file = "src/games/pp8/the-wheel/views/spin/Rainbow.vue";
            const ne = ee.exports;
            var ie = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var ae = (0, v.Z)(le, ie, [], !1, null, "0615db9e", null);
            ae.options.__file = "src/games/pp8/the-wheel/views/spin/Win.vue";
            const ce = ae.exports;
            y.p8.registerPlugin(Ds.FB);
            const oe = l().extend({
                components: {
                    SpinAnswer: Ks,
                    SpinMain: Js,
                ...
                data() {
                    ...
                    return {
                        ...
                        sliceManager: new Nt(this.player.slices, this.player.category, this.info, this.players),
                        initialY: 0,
                ...
                watch: {
                    ...
                    isRainbowActive: function(t) {
                        var s;
                        t || (this.hasSent = !1, this.isSpinning = !1, y.p8.killTweensOf(this.velocityTracked), this.velocityTracked.rotation = null !== (s = this.player.initialDegrees + 10) && void 0 !== s ? s : 10)
                    }
                },
                mounted() {
                    this.$vibrate(), this.velocityTracker = Gs.H.track(this.velocityTracked, "rotation")[0]
                },
                beforeDestroy() {
                    this.$emit("statusChange", {
                        type: "none"
                ...
                methods: {
                    onPointerBoxStart(t) {
                        this.hasSent ? t.detail.cancel() : (this.isDown = !0, this.initialRotation = this.velocityTracked.rotation, this.initialY = t.detail.pageY, y.p8.killTweensOf(this.velocityTracked))
                    },
                    onPointerBoxMove(t) {
            ...
            var re = (0, v.Z)(oe, Is, [], !1, null, "eb6d1820", null);
            re.options.__file = "src/games/pp8/the-wheel/views/spin/Spin.vue";
            const pe = re.exports;
            var he = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var ue = (0, v.Z)(ve, de, [], !1, null, "3e37dd40", null);
            ue.options.__file = "src/games/pp8/the-wheel/views/tapping-list/ToggleButton.vue";
            const Ce = ue.exports;
            var ge = function(t, s, e, n) {
                return new(e || (e = Promise))((function(i, l) {
                    function a(t) {
                        try {
                            o(n.next(t))
            ...
            var me = (0, v.Z)(ye, he, [], !1, null, "db7f36ae", null);
            me.options.__file = "src/games/pp8/the-wheel/views/tapping-list/TappingList.vue";
            const fe = me.exports;
            var xe = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var Me = (0, v.Z)(_e, xe, [], !1, null, "42945394", null);
            ...
            const Le = l().extend({
                ...
                computed: {
                    ...
                    slots() {
                        const t = ze[this.player.answers.length];
                        let s = -1;
            ...
            var Se = (0, v.Z)(Le, we, [], !1, null, null, null);
            Se.options.__file = "src/games/pp8/the-wheel/views/typing-list/TypingList.vue";
            const Ee = Se.exports;
            var Ae = function() {
                var t = this,
                    s = t.$createElement,
            ...
            var ke = (0, v.Z)(Be, Ae, [], !1, null, "f4883964", null);
            ke.options.__file = "src/games/pp8/the-wheel/views/Waiting.vue";
            const Ne = ke.exports;
            l().use(r);
            const Ze = l().extend({
                components: {
            ...
            var Pe = (0, v.Z)(Ze, n, [], !1, null, null, null);
            Pe.options.__file = "src/games/pp8/the-wheel/views/Main.vue";
            const Oe = Pe.exports
        },
        66261: t => {
            "use strict";
...
//# sourceMappingURL=5815.f60061679539906c3c85.js.map