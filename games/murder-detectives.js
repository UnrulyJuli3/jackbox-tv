(self.webpackChunkjackbox_tv = self.webpackChunkjackbox_tv || []).push([
    ["games/murder-detectives"], {
        59694: t => {
            ...
            t.exports = function(t) {
                ...
                var s, n = function(t, e) {
                    ...
                    a = new Map,
                    r = function(t) {
                        a.has(t) && clearTimeout(a.get(t)), a.set(t, setTimeout(t, 100))
                    },
                    l = function(t, e, i) {
                        ...
                        for (var n in s)
                            if (s.hasOwnProperty(n))
                                if ("string" == typeof e) s[n] = e + " " + i;
                                    ...
                                    for (var o = "", a = 0, r = e.length; a < r; a += 1) o += e[a] + " " + i + ", ";
                                    s[n] = o.slice(0, -2)
                                } return s
                    },
                    m = function(t) {
                ...
                }, w = _) : s = _, x.prototype.on = function(t, e) {
                    var i, s = t.split(/[ ,]+/g);
                ...
                T.prototype = new E, T.constructor = T, T.id = 0, T.prototype.buildEl = function(t) {
                    ...
                    var s = i.options.fadeTime + "ms",
                        n = {};
                    n.front = u("transition", ["top", "left"], s);
                    var o = {
                        front: {}
                    };
                    o.front = {
                    ...
                    var e, i, s, n = t.angle.radian,
                        o = Math.PI / 4,
                        a = Math.PI / 2;
                    if (n > o && n < 3 * o && !t.lockX ? e = "up" : n > -o && n <= o && !t.lockY ? e = "left" : n > 3 * -o && n <= -o && !t.lockX ? e = "down" : t.lockY || (e = "right"), t.lockY || (i = n > -a && n < a ? "left" : "right"), t.lockX || (s = n > 0 ? "up" : "down"), t.force > this.options.threshold) {
                        var r, l = {};
                        for (r in this.direction) this.direction.hasOwnProperty(r) && (l[r] = this.direction[r]);
                        var c = {};
                        for (r in this.direction = {
                                x: i,
                                y: s,
                                angle: e
                            }, t.direction = this.direction, l) l[r] === this.direction[r] && (c[r] = !0);
                ...
                C.prototype = new E, C.constructor = C, C.id = 0, C.prototype.prepareNipples = function() {
                    var t = this.nipples;
                    ...
                    return n.dataOnly || (p(r.ui.el, s), p(r.ui.front, r.frontPosition)), this.nipples.push(r), this.trigger("added " + r.identifier + ":added", r), this.manager.trigger("added " + r.identifier + ":added", r), this.bindNipple(r), r
                    ...
                    var e = this,
                        i = e.options,
                        s = t;
                    return t = h(t), e.updateBox(), f(t, (function(n) {
                    ...
                    var c = function(e) {
                        e.trigger("start", e), i.trigger("start " + e.id + ":start", e), e.show(), a > 0 && i.pressureFn(t, e, e.identifier), i.processOnMove(t)
                    };
                    if ((e = i.idles.indexOf(l)) >= 0 && i.idles.splice(e, 1), i.actives.push(l), i.ids.push(l.identifier), "semi" !== s.mode) c(l);
                    else {
                        if (!(n(r, l.position) <= s.catchDistance)) return l.destroy(), void i.processOnStart(t);
                        c(l)
                    }
                    return l
                    ...
                    if (function(t) {
                        ...
                        var h, d, u, m, v, f, y, g, b, _, w = n(c, s.position),
                            x = (h = c, u = (d = s.position).x - h.x, m = d.y - h.y, function(t) {
                        ...
                        if ("circle" === s.options.shape ? (v = Math.min(w, l), y = s.position, g = v, _ = {
                                x: 0,
                                y: 0
                            }, b = o(b = x), _.x = y.x - g * Math.cos(b), _.y = y.y - g * Math.sin(b), f = _) : (f = function(t, e, i) {
                                return {
                                    x: Math.min(Math.max(t.x, e.x - i), e.x + i),
                                    y: Math.min(Math.max(t.y, e.y - i), e.y + i)
                                }
                            }(c, s.position, l), v = n(f, s.position)), e.follow) {
                            if (w > l) {
                                var C = c.x - f.x,
                                    O = c.y - f.y;
                                s.position.x += C, s.position.y += O, s.el.style.top = s.position.y - (this.box.top + a.y) + "px", s.el.style.left = s.position.x - (this.box.left + a.x) + "px", w = n(c, s.position)
                            }
                        } else c = f, w = v;
                        ...
                        s.frontPosition = {
                            x: S,
                            y: k
                        }, e.dataOnly || p(s.ui.front, s.frontPosition);
                        var M = {
                ...
                S.prototype = new E, S.constructor = S, S.prototype.prepareCollections = function() {
                    var t = this;
        ...
        94835: (t, e, i) => {
            ...
            var h = (0, i(51900).Z)(c, s, [], !1, null, "2df46cec", null);
            h.options.__file = "src/apps/vue/components/Tutorial.vue";
            const d = h.exports
        },
        17819: (t, e, i) => {
            "use strict";
        ...
        74634: (t, e, i) => {
            ...
            var a = (0, i(51900).Z)(o, s, [], !1, null, null, null);
        ...
        28274: (t, e, i) => {
            ...
            var d = i(51900),
                p = (0, d.Z)(h, l, [], !1, null, null, null);
            p.options.__file = "src/games/pp8/murder-detectives/views/Lobby.vue";
            const u = p.exports;
            var m = function() {
                var t = this,
                    e = t.$createElement,
            ...
            var _ = (0, d.Z)(b, m, [], !1, null, "57793e1c", null);
            _.options.__file = "src/games/pp8/murder-detectives/views/PostGame.vue";
            const w = _.exports;
            var x = function() {
                var t = this,
                    e = t.$createElement,
            ...
            class S extends T.f {
                ...
                updateSymbolLines() {
                    ...
                    let a = Number.MAX_SAFE_INTEGER,
                        ...
                        c = 0;
                    const h = t.map((t => Object.assign(Object.assign({}, t), {
                            points: t.points.map((t => {
                                ...
                                let p, u;
                                return p = Math.cos(o) * (h - e) - Math.sin(o) * (d - i) + e, u = Math.sin(o) * (h - e) + Math.cos(o) * (d - i) + i, p -= e, u -= i, p = (p + e) * n, u = (u + i) * n, p += s.x - e * n, u += s.y - i * n, a = Math.min(a, p), r = Math.max(r, p), l = Math.min(l, u), c = Math.max(c, u), {
                                    x: p,
                                    y: u
                                }
                            }))
                        ...
                        d = t[0].thickness,
                        p = Math.min((this.renderCanvas.width - d) / (r - a), 1),
                        u = Math.min((this.renderCanvas.height - d) / (c - l), 1),
                        m = Math.min(p, u),
                        v = .5 * d,
                        f = Math.min(0, a - v) + Math.max(0, r - (this.renderCanvas.width - v)),
                        y = Math.min(0, l - v) + Math.max(0, c - (this.renderCanvas.height - v)),
                        g = h.map((t => Object.assign(Object.assign({}, t), {
                            points: t.points.map((t => ({
                                x: m * (t.x - f),
                                y: m * (t.y - y)
                            })))
            ...
            const M = o().extend({
                ...
                mounted() {
                    this.audience ? this.throttledSubmitVote = (0, E.throttle)(this.submitAudienceVote.bind(this), 400) : this.throttledSubmitVote = (0, E.throttle)(this.submitVote.bind(this), 400)
                },
                beforeDestroy() {
                    var t;
                ...
                methods: {
                    getWeaponImage(t) {
                        ...
                        const e = new S(document.createElement("p"), t.size.width, t.size.height, {
            ...
            var P = (0, d.Z)(M, x, [], !1, null, null, null);
            P.options.__file = "src/games/pp8/murder-detectives/views/Choosing.vue";
            const N = P.exports;
            var D = function() {
                var t = this,
                    e = t.$createElement,
            ...
            var $ = (0, d.Z)(R, D, [], !1, null, null, null);
            $.options.__file = "src/games/pp8/murder-detectives/views/Drawing.vue";
            const U = $.exports;
            var j = function() {
                var t = this,
                    e = t.$createElement,
            ...
            const G = o().extend({
                ...
                mounted() {
                    this.throttledSubmit = (0, E.throttle)(this.submit.bind(this), 400)
                },
                beforeDestroy() {
                    var t;
                    ...
                    submit(t) {
                        return e = this, i = void 0, n = function*() {
                            try {
                                ...
                                t instanceof B.EcastRateLimitExceeded || this.$handleEcastError(t)
                            }
            ...
            var z = (0, d.Z)(G, j, [], !1, null, null, null);
            z.options.__file = "src/games/pp8/murder-detectives/views/Soundboard.vue";
            const W = z.exports;
            var H = function() {
                var t = this,
                    e = t.$createElement,
            ...
            const K = o().extend({
                ...
                methods: {
                    onStabClick() {
                        Math.random() < .5 ? (this.shuffledHitMessages.length || (this.shuffledHitMessages = (0, E.shuffle)(this.player.hitMessages)), this.result = this.shuffledHitMessages.pop()) : (this.shuffledMissMessages.length || (this.shuffledMissMessages = (0, E.shuffle)(this.player.missMessages)), this.result = this.shuffledMissMessages.pop()), this.timeout = window.setTimeout((() => {
                            this.result = void 0
                        }), 7e3)
                    }
                }
            });
            var V = (0, d.Z)(K, H, [], !1, null, null, null);
            V.options.__file = "src/games/pp8/murder-detectives/views/Stabbing.vue";
            const Z = V.exports;
            var F = function() {
                var t = this,
                    e = t.$createElement,
            ...
            var q = (0, d.Z)(J, F, [], !1, null, null, null);
            q.options.__file = "src/games/pp8/murder-detectives/views/Inspecting.vue";
            const Q = q.exports;
            var tt = function() {
                var t = this,
                    e = t.$createElement,
            ...
            var it = (0, d.Z)(et, tt, [], !1, null, null, null);
            it.options.__file = "src/games/pp8/murder-detectives/views/Waiting.vue";
            const st = it.exports;
            var nt = function() {
                var t = this,
                    e = t.$createElement,
            ...
            const lt = o().extend({
                ...
                mounted() {
                    this.autoSubmitter = (0, E.throttle)(this.autoSubmit.bind(this), 400), at()(this.$refs.textarea), this.player.textKey && this.restoreText()
                },
                beforeDestroy() {
                    ...
                    autoSubmit() {
                        return rt(this, void 0, void 0, (function*() {
                            if (!this.isSubmitting) try {
                                ...
                                t instanceof B.EcastFilterError || this.$handleEcastError(t), yield this.$ecast.updateText(this.player.textKey, "")
                            }
                        }))
                    },
                    onKeypress(t) {
            ...
            var ct = (0, d.Z)(lt, nt, [], !1, null, null, null);
            ct.options.__file = "src/games/pp8/murder-detectives/views/Writing.vue";
            const ht = ct.exports;
            const dt = o().extend({
                bb: {
                    header: (t, e) => `<h3>${e}</h3>`,
            ...
            var pt = (0, d.Z)(dt, s, [], !1, null, null, null);
            pt.options.__file = "src/games/pp8/murder-detectives/views/Main.vue";
            const ut = pt.exports
        },
        71319: (t, e, i) => {
            "use strict";
...
//# sourceMappingURL=8274.0f3e4356e338d8666605.js.map